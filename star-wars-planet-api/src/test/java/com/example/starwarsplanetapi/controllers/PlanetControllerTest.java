package com.example.starwarsplanetapi.controllers;
...
import com.example.starwarsplanetapi.domain.services.PlanetService;
...
;
  ...
  public void removePlanet_WithUnexistingId_ReturnsNotFound() throws Exception {
    ...
    mockMvc.perform(delete("/planetes/" + planetId))
    .andExpect(status().isNotFound());
  }
